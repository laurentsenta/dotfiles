...
(defface rainbow-delimiters-unmatched-face
  '((((background light)) (:foreground "#FF090B"))
    (((background dark)) (:foreground "#FF090B")))
...
(defface rainbow-delimiters-depth-1-face
  '((((background light)) (:foreground "#D9D9D9"))
    (((background dark)) (:foreground  "#D9D9D9")))
...
(defface rainbow-delimiters-depth-2-face
  '((((background light)) (:foreground "#8C701B"))
    (((background dark)) (:foreground  "#8C701B")))
  "Nested delimiters face, depth 2."
  :group 'rainbow-delimiters-faces)

(defface rainbow-delimiters-depth-3-face
  '((((background light)) (:foreground "#D49716"))
    (((background dark)) (:foreground  "#D49716")))
  "Nested delimiters face, depth 3."
  :group 'rainbow-delimiters-faces)

(defface rainbow-delimiters-depth-4-face
  '((((background light)) (:foreground "#A65526"))
    (((background dark)) (:foreground  "#A65526")))
