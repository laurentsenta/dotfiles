...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ 1, "2:sys", "3:social", "4:doc", "5:dev", "6:term", "7:net", "8:media", 9 }, s, layouts[1])
end
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "XF86MonBrightnessDown", function ()
        awful.util.spawn_with_shell("/home/laurent/dev/dotfiles/bin/xbacklight_alien -dec 5") end),
    awful.key({ }, "XF86MonBrightnessUp", function ()
        awful.util.spawn_with_shell("/home/laurent/dev/dotfiles/bin/xbacklight_alien -inc 5") end),
    awful.key({ }, "XF86KbdBrightnessDown", function ()
        awful.util.spawn_with_shell("/home/laurent/dev/dotfiles/bin/kbdbacklight_alien -dec 10") end),
    awful.key({ }, "XF86KbdBrightnessUp", function ()
        awful.util.spawn_with_shell("/home/laurent/dev/dotfiles/bin/kbdbacklight_alien -inc 10") end)
